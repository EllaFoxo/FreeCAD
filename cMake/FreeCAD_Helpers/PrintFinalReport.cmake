macro(PrintFinalReport)
    ...
    conditional(QtGui BUILD_GUI "not needed" ${QtGui_VERSION})
    conditional(QtQuick BUILD_NEXT_GEN_UI "not needed" ${QtQuick_VERSION})
    conditional(QtQml BUILD_NEXT_GEN_UI "not needed" ${QtQml_VERSION})
    conditional(QtQuickControls2 BUILD_NEXT_GEN_UI "not needed" ${QtQuickControls2_VERSION})
    conditional(QtQuick3D BUILD_NEXT_GEN_UI "not needed" ${QtQuick3D_VERSION})
